...
<template>
  ...
  <section class="w-full flex justify-between my-6">
    <BaseButtonUtilsVue @click.prevent="actionShowModalCreateNewCategory">
    ...
    <template v-slot:modalBody>
      <div v-if="!isUpdate">
        ...
        <form @submit.prevent="actionCreate" id="form">
          ...
          <BaseButtonUtilsVue type="submit"  class="w-full justify-center">Create</BaseButtonUtilsVue> 
        </form>
      </div>
      <div v-else>
        <BaseLoadingUtils v-if="showLoading" />
        ...
        <form @submit.prevent="actionUpdate" id="form-update">
          ...
          <BaseButtonUtilsVue type="submit"  class="w-full justify-center">Update</BaseButtonUtilsVue>
