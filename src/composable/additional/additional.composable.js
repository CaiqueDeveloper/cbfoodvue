    ...
    const columns = [
        {
            ...
            fill="currentColor" class="bi bi-plus-circle-fill cursor-pointer text-indigo-800  hover:text-indigo-300  focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium  text-sm   dark:text-orange-700 dark:focus:ring-orange-800" 
            viewBox="0 0 16 16">
